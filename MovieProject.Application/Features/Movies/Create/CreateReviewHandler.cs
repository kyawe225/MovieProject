...
namespace MovieProject.Application.Features.Moives;

public class CreateMovieHandler(ICrudRepository<Movie, Object> repository) : IRequestHandler<CreateMovieCommand, ResponseModel<string>>
{
